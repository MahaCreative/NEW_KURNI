    ...
    const addHandler = () => {
        if (
            ...
            swalWithBootstrapButtons
                .fire({
                    title: "Anda yakin?",
                    text: `Apakah anda akan menambahkan anggota keluarga ${data.nama_pengikut}?`,
                    icon: "warning",
                    showCancelButton: true,
                    confirmButtonText: "Ya, Saya Yakin",
                    cancelButtonText: "Tidak, Batalkan Penambahan Pengikut!",
                    reverseButtons: true,
                })
                .then((result) => {
                    if (result.isConfirmed) {
                        ...
                        errors.nik_pengikut = "";
                        errors.nama_pengikut = "";
                        errors.shdk_pengikut = "";
                        setData({
                            ...data,
